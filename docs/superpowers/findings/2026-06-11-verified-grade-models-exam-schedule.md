...
### 1.1 ALO — Algebra Liniară și Optimizare
...
### 1.2 PS — Probabilități și Statistică
...
### 1.3 POO — Programare Orientată pe Obiecte (CS1201)
...
### 1.4 PA — Proiectarea Algoritmilor (CS1205)
...
### 1.5 SORC — Sisteme de Operare și Rețele de Calculatoare (ONE subject, SO + RC halves)
...
## 2. IA12 exam schedule (official, verified)
